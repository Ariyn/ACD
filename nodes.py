from Api import api, endPointTo, filtering
...
class Files:
	...
	@endPointTo("nodes", "cdproxy")
	@api
	def upload(url, name, file, kind="FILE", **kwargs):
		...
		boundary = "----BOUNDARY_WORD_eR45rtF5U3ZX9j"
		fileName, fileData = file, open(file,"rb").read()
